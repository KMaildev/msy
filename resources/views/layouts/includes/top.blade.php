    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                <b>
                    <img src="{{ asset('design/assets/images/logo-icon.png') }}" alt="homepage"
                        class="dark-logo" />
                    <img src="{{ asset('design/assets/images/logo-light-icon.png') }}" alt="homepage"
                        class="light-logo" />
                </b>
                <!-- Logo text --><span class="hidden-sm-down">
                    <img src="{{ asset('design/assets/images/logo-text.png') }}" alt="homepage"
                        class="dark-logo" />
                    <img src="{{ asset('design/assets/images/logo-light-text.png') }}" class="light-logo"
                        alt="homepage" />
                </span>
            </a>
        </div>
